...
**Symptoms**:
- Red error message in HyperFix UI
...
<Tip>
Use the "Browse Repositories" feature in HyperFix to see which repositories your app can access.
</Tip>
...
2. **Update Installation**
   ...
   - Go to [GitHub App installations](https://github.com/settings/installations)
   - Click "Configure" on your HyperFix app
...
3. **Restart Backend Service**
   ...
   - For Kubernetes: `kubectl rollout restart deployment/hyperfix-backend`
...
**Problem**: GitHub events aren't reaching HyperFix.

**Symptoms**:
- Webhook events listed in GitHub but no logs in HyperFix
...
**Problem**: Webhooks reach HyperFix but signature verification fails.
...
**Problem**: Labels aren't syncing between HyperFix and GitHub.

**Symptoms**:
- Changing priority in HyperFix doesn't update GitHub labels
- Adding labels in GitHub doesn't reflect in HyperFix
...
3. **Check Webhook Events**
   ...
   - Without these, label changes from GitHub won't sync to HyperFix
...
2. **Test Repository Access**
   - Use the "Browse Repositories" feature in HyperFix
...
2. **Gather Information**
   ...
   - Check both HyperFix logs and GitHub webhook delivery logs
   - Document your environment (Docker, Kubernetes, etc.)

3. **Test Basic Functionality**
   - Try creating a task without GitHub integration
   - Verify your HyperFix instance is working normally
...
- **[GitHub Issues](https://github.com/samalehzen/hyper/issues)** - Report bugs or request features
...
**Still stuck?** The HyperFix community is here to help! Join our [Discord](https://discord.gg/rU4tSyhXXU) for real-time support.