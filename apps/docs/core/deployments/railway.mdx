---
title: Railway
description: Deploy HyperFix to Railway using the official template.
---
import { DeployButton } from "@/components/ai/page-actions";

## Railway Template

HyperFix provides an official Railway template for easy deployment with a single click.

<DeployButton href="https://railway.com/deploy/hyperfix">
  Deploy on Railway
</DeployButton>
