---
title: GitHub
description: GitHub is a social provider for HyperFix.
---

## Overview

GitHub is a social provider for HyperFix. It allows users to sign in to HyperFix using their GitHub account.
...
Once you have configured the social provider, you can sign in to HyperFix using your GitHub account.