...
description: Set up your first workspace and project structure in HyperFix
---

This guide covers the first functional setup inside HyperFix so your team can begin tracking work immediately.
