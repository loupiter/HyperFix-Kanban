...
import { HyperFixIssueLink } from "./extensions/hyperfix-issue-link";
import {
  ...
  return (
    ...
    >
      ...
      {editor && (
        <BubbleMenu
          editor={editor}
          className="hyperfix-tiptap-bubble"
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className="hyperfix-tiptap-bubble-btn"
            onClick={() =>
          ...
          <span className="hyperfix-tiptap-bubble-separator" />
          <Button
            type="button"
            variant="ghost"
            size="xs"
          ...
          {embedComposer.mode === "choice" ? (
            <div className="hyperfix-embed-choice-menu">
              ...
              >
                ...
                <span className="hyperfix-embed-choice-hint">Tab</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className="hyperfix-embed-choice-hint">Esc</span>
              </button>
            </div>
          ) : (
            <form
      ...
      <EditorContent
        editor={editor}
        className="hyperfix-tiptap-content"
