...
export const EmbedBlock = Node.create({
  ...
  parseHTML() {
    return [
      {
        tag: "hyperfix-embed[url]",
      },
      {
        tag: "div[data-type='hyperfix-embed'][data-url]",
      },
    ];
  },
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    if (mode === "embed") {
      return [
        ...
        [
          "div",
          { class: "hyperfix-embed-unsupported" },
  ...
  renderMarkdown(
    ...
    return `\n<hyperfix-embed url="${escapeHtml(url)}" mode="${mode}" />\n`;
  },
});
