...
import { HyperFixIssueLink } from "@/components/task/extensions/hyperfix-issue-link";
import {
...
export default function CommentEditor({
  ...
  const editor = useEditor(
    {
      ...
      extensions: [
        StarterKit.configure({
          ...
          trailingNode: false,
          codeBlock: {
            HTMLAttributes: { class: "hyperfix-tiptap-codeblock" },
          },
        }),
        Link.configure({
          autolink: true,
      ...
      editorProps: {
        attributes: {
          class: cn(
            proseClassName || "hyperfix-comment-editor-prose",
            readOnly && "hyperfix-comment-editor-prose-readonly",
          ),
        },
          ...
          if (issueKey || taskIdFromUrl) {
            ...
            view.dispatch(
              view.state.tr.replaceSelectionWith(
                view.state.schema.nodes.hyperfixIssueLink.create({
                  url,
                  issueKey: issueKey || "",
  ...
  useEffect(() => {
    ...
    const handleImagePreviewClick = (event: MouseEvent) => {
      ...
      if (!target.classList.contains("hyperfix-editor-image")) return;
  ...
  const handleEditorMouseMove = useCallback(
    (event: ReactMouseEvent<HTMLElement>) => {
      ...
      if (target.closest(".hyperfix-codeblock-language")) return;
      const hovered = target.closest(
        "pre.hyperfix-tiptap-codeblock",
      ) as HTMLElement | null;
  ...
  const handleEditorMouseLeave = useCallback(
    (event: ReactMouseEvent<HTMLElement>) => {
      ...
      if (relatedTarget?.closest(".hyperfix-codeblock-language")) return;
      ...
      codeLanguageHideTimeoutRef.current = window.setTimeout(() => {
        ...
        const pickerIsHovered = Boolean(
          document.querySelector(".hyperfix-codeblock-language:hover"),
        );
  ...
  return (
    <section
      ...
      className={cn(
        "hyperfix-comment-editor-shell",
        isDragActive && "is-drag-active",
        readOnly && "hyperfix-comment-editor-shell-readonly",
        className,
      )}
    ...
    >
      ...
      {editor && hoveredCodeBlock && !disabled && (
        <div
          className="hyperfix-codeblock-language"
          style={{
        ...
        >
          <button
            type="button"
            className="hyperfix-codeblock-language-trigger hyperfix-codeblock-copy-trigger"
            aria-label={
              isCodeCopied
          ...
          {!readOnly && (
            ...
            >
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="hyperfix-codeblock-language-trigger"
                >
      ...
      {editor && !readOnly && !disabled && showBubbleMenu && (
        <BubbleMenu
          editor={editor}
          className="hyperfix-comment-editor-bubble"
        ...
        >
          <Button
            ...
            size="xs"
            className={cn(
              "hyperfix-comment-editor-bubble-btn",
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className="hyperfix-comment-editor-bubble-btn"
      ...
      {slashMenu && !readOnly && !disabled && (
        <div
          className="hyperfix-tiptap-slash-menu"
          style={{
            top: slashMenu.top,
            left: slashMenu.left,
            position: slashMenuPosition,
        ...
        >
          {filteredSlashCommands.length > 0 ? (
            groupedSlashCommands.map((group) => {
              ...
              return (
                <div key={group.title} className="hyperfix-tiptap-slash-group">
                  <div className="hyperfix-tiptap-slash-group-title">
                    {group.title}
                  </div>
                  {group.items.map((command) => {
                    ...
                    return (
                      ...
                      >
                        <span className="hyperfix-tiptap-slash-label">
                          {command.label}
                        </span>
                        {command.shortcut && (
                          <span className="hyperfix-tiptap-slash-shortcut">
                            {command.shortcut}
                          </span>
                        )}
                      </button>
            ...
            <div className="hyperfix-tiptap-slash-empty">
      ...
      {editor && embedComposer && (
        <div
          className="hyperfix-embed-composer"
          style={{
        ...
        >
          {embedComposer.mode === "choice" ? (
            <div className="hyperfix-embed-choice-menu">
              <button
                type="button"
                className="hyperfix-embed-choice-item is-primary"
                onMouseDown={(event) => {
                  event.preventDefault();
                  submitEmbedComposer("embed");
                }}
              >
                ...
                <span className="hyperfix-embed-choice-hint">
                  {t("activity:comment.editor.hintTab")}
                </span>
              </button>
              <button
                type="button"
                className="hyperfix-embed-choice-item"
                onMouseDown={(event) => {
                  event.preventDefault();
                  setEmbedComposer(null);
                  setEmbedComposerError(null);
            ...
            <form
              className="hyperfix-embed-composer-form"
              onSubmit={(event) => {
                event.preventDefault();
                submitEmbedComposer("embed");
              }}
            >
              <Input
                ...
                autoFocus
              />
              <div className="hyperfix-embed-composer-actions">
                <Button
                  type="button"
                  size="xs"
                  variant="ghost"
              ...
              {embedComposerError && (
                <p className="hyperfix-embed-composer-error">
      ...
      <EditorContent
        editor={editor}
        className={cn("hyperfix-comment-editor-content", contentClassName)}
      ...
      {!readOnly && !disabled && showQuickAttachButton && (
        <button
          type="button"
          className="hyperfix-editor-quick-attach"
          onMouseDown={(event) => {
            event.preventDefault();
          }}
          onClick={() => openImagePicker(editor)}
      ...
      {isDragActive && (
        <div className="hyperfix-editor-drop-indicator">
