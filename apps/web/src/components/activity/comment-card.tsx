      ...
      <div className="group relative w-full rounded-xl border border-border/80 bg-card/60">
        ...
        <div className="pt-0.5">
          <CommentEditor
            ...
            className={
              isEditing
                ? "[&_.hyperfix-comment-editor-content_.ProseMirror]:min-h-[3rem] [&_.hyperfix-comment-editor-content_.ProseMirror]:max-h-none [&_.hyperfix-comment-editor-content_.ProseMirror]:overflow-visible [&_.hyperfix-comment-editor-content_.ProseMirror]:px-3 [&_.hyperfix-comment-editor-content_.ProseMirror]:pt-2.5 [&_.hyperfix-comment-editor-content_.ProseMirror]:pb-2"
                : "hyperfix-comment-viewer [&_.hyperfix-comment-editor-content_.ProseMirror]:px-3 [&_.hyperfix-comment-editor-content_.ProseMirror]:pt-2 [&_.hyperfix-comment-editor-content_.ProseMirror]:pb-3"
            }
            autoFocus={isEditing}
            readOnly={!isEditing}
