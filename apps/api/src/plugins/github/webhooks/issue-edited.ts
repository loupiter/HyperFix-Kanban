    ...
    if (changes.title) {
      ...
      if (lastTitleSync) {
        if (
          ...
          lastTitleSync.source === "hyperfix"
        ) {
          console.log("Skipping title update - already synced from HyperFix");
    ...
    if (changes.body) {
      ...
      if (lastDescSync) {
        if (
          ...
          lastDescSync.source === "hyperfix"
        ) {
          console.log(
            "Skipping description update - already synced from HyperFix",
          );
