 ...
 * Returns null if no valid priority label found (lets HyperFix use its defaults).
 */
 ...
 * Returns null if no valid status label found (lets HyperFix use its defaults).
 */
