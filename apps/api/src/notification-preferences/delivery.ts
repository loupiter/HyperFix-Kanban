...
import { sendNotificationEmail } from "@hyperfix/email";
    ...
    case "task_created": {
      ...
      return {
        ...
        body: taskTitle
          ...
          : "A new task was created in HyperFix.",
      };
    }
    case "workspace_created": {
      ...
      return {
        ...
        body: workspaceName
          ...
          : "A new workspace was created in HyperFix.",
      };
    }
      ...
      return {
        ...
        body:
          taskTitle && oldStatus && newStatus
            ...
            : "A task status changed in HyperFix.",
      };
    }
    case "task_assignee_changed": {
      ...
      return {
        ...
        body: taskTitle
          ...
          : "A task was assigned to you in HyperFix.",
      };
    }
    case "time_entry_created": {
      ...
      return {
        ...
        body: taskTitle
          ...
          : "A time entry was created in HyperFix.",
      };
    }
...
async function sendWebhookNotification(input: {
  ...
  if (input.secret) {
    headers["X-HyperFix-Signature"] = createHmac("sha256", input.secret)
      .update(body)
      .digest("hex");
  }
  ...
  if (decryptedPreference.emailEnabled && rule.emailEnabled && user.email) {
    deliveries.push(
      sendNotificationEmail(user.email, content.title, {
        ...
        actionLabel: context.taskUrl ? "Open in HyperFix" : undefined,
