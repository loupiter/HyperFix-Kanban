# Contributing to HyperFix

Thanks for wanting to contribute to HyperFix! Whether you're fixing bugs, adding features, or improving docs, we appreciate your help.
...
```bash
git clone https://github.com/yourusername/hyperfix.git
cd hyperfix
```
...
- **Browse [open issues](https://github.com/samalehzen/hyper/issues)** - look for "good first issue" labels
...
HyperFix uses [i18next](https://www.i18next.com/) with [react-i18next](https://react.i18next.com/) in the web app. We want user-facing copy to stay consistent, translatable, and easy to maintain.
...
- **Issues**: Open a [GitHub issue](https://github.com/samalehzen/hyper/issues) for bugs or feature requests
...
- **Documentation** - Help others understand how to use HyperFix
- **Performance improvements** - Make things faster
- **Accessibility** - Help make HyperFix usable for everyone

Thanks for contributing to HyperFix! 🚀
