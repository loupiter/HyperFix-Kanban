...
const messages = {
  en: {
    preview: "You're invited to {{workspaceName}} on HyperFix",
    title: "Join {{workspaceName}}",
    subtitle:
      "{{inviterName}} ({{inviterEmail}}) invited you to collaborate in HyperFix.",
    ...
    footer: "HyperFix workspace invitation",
  },
  de: {
    preview: "Du wurdest zu {{workspaceName}} auf HyperFix eingeladen",
    title: "{{workspaceName}} beitreten",
    subtitle:
      "{{inviterName}} ({{inviterEmail}}) hat dich eingeladen, in HyperFix zusammenzuarbeiten.",
    ...
    footer: "HyperFix Workspace-Einladung",
  },
} as const;
...
WorkspaceInvitationEmail.PreviewProps = {
  ...
  invitationLink: "https://coubeche.hypeer.cloud/invite/abc123",
