...
const PasswordResetEmail = ({
  ...
  <EmailShell
    preview="Reset your HyperFix password"
  ...
  >
    <Section>
      ...
      <Text style={styles.footer}>HyperFix security email</Text>
    </Section>
  </EmailShell>
);

PasswordResetEmail.PreviewProps = {
  resetLink: "https://coubeche.hypeer.cloud/auth/reset-password?token=example",
  userName: "Jane",
