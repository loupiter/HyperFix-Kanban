...
import { z } from "zod";
import type { HyperFixClient } from "../hyperfix/client.js";
import { buildFullTaskUpdateBody } from "../hyperfix/task-helpers.js";
...
export function registerTools(
  ...
  server.registerTool(
    ...
    {
      description:
        "Return the current HyperFix session and user for the cached device token.",
